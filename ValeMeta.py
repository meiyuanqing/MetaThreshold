...
Deriving Vale's method threshold by meta-analysis.
...
def vale_meta(t_dir="F:\\NJU\\MTmeta\\experiments\\unsupervised\\trainingData\\",
    ...
    df = pd.read_csv(meta_dir + "Vale_Threshold_minified.csv", keep_default_na=False, na_values=[""])
...
if __name__ == '__main__':
    ...
    print("The __name__ is ", __name__, ". This is end of ValeMeta.py!")
