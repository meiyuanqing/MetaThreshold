...
def auc_testing_meta(meta_dir="F:\\NJU\\MTmeta\\experiments\\pooled\\"):
    import os
    import csv
    ...
    df = pd.read_csv(meta_dir + "AUCs.csv", keep_default_na=False, na_values=[""])
...
if __name__ == '__main__':
    ...
    print("The __name__ is ", __name__, ". This is end of AucOnTestingDataMeta.py!\n",
          "The execution time of AucOnTestingDataMeta.py script is ", execution_time)
